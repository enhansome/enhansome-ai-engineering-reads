...
* [LangChain cookbook](https://github.com/langchain-ai/langchain/tree/master/cookbook) ⭐ 146,067 | 🐛 476 | 🌐 Python | 📅 2026-09-10
* [seamless\_communication](https://github.com/facebookresearch/seamless_communication) ⭐ 11,854 | 🐛 252 | 🌐 Jupyter Notebook | 📅 2026-09-08
* [Langchain Tutorials](https://github.com/gkamradt/langchain-tutorials) ⭐ 7,492 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2024-08-05
...
* [OpenAI's Code Interpreter in your terminal, running locally](https://github.com/KillianLucas/open-interpreter) ⭐ 68,290 | 🐛 2 | 🌐 Rust | 📅 2026-09-09
...
* [AI Observability & Evaluation - Evaluate, troubleshoot, and fine tune your LLM, CV, and NLP models in a notebook.](https://github.com/Arize-ai/phoenix) ⭐ 11,408 | 🐛 969 | 🌐 Python | 📅 2026-09-10
...
* [Generative AI for Beginners - A Course](https://github.com/microsoft/generative-ai-for-beginners/tree/main) ⭐ 119,479 | 🐛 23 | 🌐 Jupyter Notebook | 📅 2026-09-10
* [Artificial Intelligence for Beginners - A Curriculum](https://github.com/microsoft/ai-for-beginners) ⭐ 68,341 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-09-04
* [Finetuning Large Language Models](https://www.deeplearning.ai/short-courses/finetuning-large-language-models/)
* [Large Language Models with Semantic Search](https://www.deeplearning.ai/short-courses/large-language-models-semantic-search/)
...
* [A guidance language for controlling large language models.](https://github.com/guidance-ai/guidance) ⭐ 21,747 | 🐛 323 | 🌐 Jupyter Notebook | 📅 2026-05-21
